...
const cacheName = 'InClassProjectLogInSignIn-2021-04-20 19:38:46.664490'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'InClassProjectLogInSignIn'.length) === 'InClassProjectLogInSignIn') {
